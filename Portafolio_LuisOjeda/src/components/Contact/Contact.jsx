...
const socialLinks = [
  {
    name: "GitHub",
    url: "https://github.com/LuisAOL2003",
    icon: <Github />,
    color: "primary",
  },
  {
    name: "LinkedIn",
    url: "https://www.linkedin.com/in/luis-ojeda-93871729b",
    icon: <LinkedIn />,
    color: "secondary",
  },
  {
    name: "Email",
    url: "mailto:luisojelopez@gmail.com",
    icon: <Mail />,
    color: "accent",
  },
];
...
function Contact() {
  ...
  useEffect(() => {
    ...
    ); // Pause 3s on English, 250ms otherwise
        ...
        >
          ...
          >
                ...
                <AnimatePresence mode="wait">
                  <motion.span
                    ...
                    style={{
                      ...
                      fontSize: [0, 1, 3, 7].includes(currentLangIndex)
                        ? "0.7em"
                        : "1em",
                    }}
                  >
            ...
            <p className={styles.description}>
              I am currently available for remote work, freelance projects, and
              full-time opportunities. I specialize in web development with a
              strong focus on backend technologies such as Node.js, TypeScript,
              APIs, and databases, while also maintaining solid frontend
              experience with React. If you are looking for a committed
              developer to build solutions and grow with your team, feel free to
              contact me.
            </p>
            ...
            <div className={styles.contactDetails}>
              <div className={styles.detailItem}>
                <Mail />
                <a href="mailto:luisojelopez@gmail.com">
                  luisojelopez@gmail.com
                </a>
              </div>

              <div className={styles.detailItem}>
                <Phone />
                <a href="tel:+584127273084">+58 412 727 3084</a>
              </div>
            </div>
