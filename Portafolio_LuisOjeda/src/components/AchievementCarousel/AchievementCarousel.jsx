...
const achievements = [
    {
        ...
        prize: 'Computer Science Degree',
        description: 'Built a strong foundation in programming, software development, databases, systems analysis, and technology management. This degree shaped my analytical thinking and my approach to solving real-world problems.',
        images: [
            '/images/computacion_1.png',
            '/images/computacion_2.png',
            '/images/computacion_3.png'
        ],
        link: 'https://www.linkedin.com/in/luis-ojeda-93871729b/',
        color: '#ffd700'
    },
    {
        id: 1,
        title: 'University Professor',
        place: 'Academic Experience',
        prize: 'Teaching & Mentoring',
        description: 'Worked as a university professor, strengthening my communication, mentoring, and planning skills while guiding students through academic and technical topics.',
        images: [
            '/images/profesor_1.png',
            '/images/profesor_2.png',
            '/images/profesor_3.png'
        ],
        link: 'https://www.linkedin.com/in/luis-ojeda-93871729b/',
        color: '#00d4ff'
    },
    {
        id: 2,
        title: 'Technology Center Coordinator',
        place: 'Leadership Role',
        prize: 'Team & Resource Management',
        description: 'Advanced from full-time assistant to coordinator, managing technological resources, supporting users, and overseeing day-to-day operations at the university technology center.',
        images: [
            '/images/coordinador_1.png',
            '/images/coordinador_2.png',
            '/images/coordinador_3.png'
        ],
        link: 'https://www.linkedin.com/in/luis-ojeda-93871729b/',
        color: '#bd00ff'
    },
    {
        ...
        place: 'Autonomous Projects',
        prize: 'Practical Web Development',
        description: 'Developed web applications independently using React, Node.js, TypeScript, and databases, covering analysis, development, testing, deployment, and maintenance.',
        images: [
            '/images/fullstack_1.png',
            '/images/fullstack_2.png',
            '/images/fullstack_3.png'
        ],
        link: 'https://www.linkedin.com/in/luis-ojeda-93871729b/',
        color: '#00ff88'
    },
    {
        id: 4,
        title: 'COFAE Project',
        place: 'Institutional Impact',
        prize: 'System Improvement',
        description: 'Contributed to the COFAE system by helping improve activities management, scheduling, and reporting, focusing on usability, structure, and operational efficiency.',
        images: [
            '/images/cofae_1.png',
            '/images/cofae_2.png',
            '/images/cofae_3.png'
        ...
        <section id="achievements" className={styles.carouselSection}>
            <div className={styles.container}>
                <motion.h2
                    ...
                    viewport={{ once: true }}
                >
                    <span className="gradient-text">Professional Milestones</span>
                </motion.h2>
