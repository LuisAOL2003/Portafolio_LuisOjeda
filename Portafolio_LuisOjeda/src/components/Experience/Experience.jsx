...
const experiences = [
    {
        ...
        company: "Public Institution – Education Sector and Fiscal Control (Venezuela)",
    ...
    {
        id: 1,
        role: "Technology Center Coordinator",
        company: "Universidad Nueva Esparta",
        date: "Feb 2024 - Sep 2025",
        skills: ["Team Coordination", "Technology Management", "Customer Service", "Problem Solving"],
        icon: <Target />,
        color: '#bd00ff'
    },
    {
        ...
        skills: ["Technical Support", "IT Resources", "User Assistance", "Operations"],
        icon: <Shield />,
        color: '#00ff88'
    },
    {
        ...
        company: "Universidad Nueva Esparta",
        date: "Feb 2023 - Feb 2024",
        skills: ["Teaching", "Communication", "Mentoring", "Planning"],
        icon: <Briefcase   />,
        color: '#00d4ff'
    },
    {
        id: 4,
        role: "Full Stack Developer",
        company: "Independent / Autonomous Projects",
